...
import {
  ...
  registerMutation,
  loginMutation,
} from 'common/mutation/user/user'
                ...
                <div className='bg-white rounded-xl p-5 shadow-md flex flex-col h-auto'>
                  <div className='pb-3 flex flex-col'>
                    ...
                    <input
                      ...
                      name='name'
                      id='name'
                      className={`rounded border h-10 p-3 my-2 ${
                        isCheck[0] ? 'border-gray-300' : 'border-red-500 rounde'
                      }`}
                  ...
                  <div className='pb-3 flex flex-col'>
                    ...
                    <input
                      ...
                      id='email'
                      className={`rounded border h-10 p-3 my-2 ${
                        isCheck[1] ? 'border-gray-300' : 'border-red-500 rounde'
                      }`}
                  ...
                  <div className='pb-3 flex flex-col'>
                    ...
                    <input
                      ...
                      id='password'
                      className={`rounded border h-10 p-3 my-2 ${
                        isCheck[2] ? 'border-gray-300' : 'border-red-500 rounde'
                      }`}
